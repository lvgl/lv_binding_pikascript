...
def palettle_lighten(color: int) -> int: ...


class style_t(TinyObj):
    def init(self): ...
    def set_radius(self, radius: int): ...
    def set_bg_opa(opa: int): ...
    def set_bg_color(color: int): ...
    def set_outline_width(w: int): ...
    def set_outline_color(color: int): ...
    def set_outline_pad(pad: int): ...
